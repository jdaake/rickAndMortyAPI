...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-1sqhcuw");
    			add_location(img, file, 57, 6, 1361);
    			attr_dev(h3, "class", "svelte-1sqhcuw");
    			add_location(h3, file, 59, 8, 1505);
    			attr_dev(div0, "class", "uk-overlay uk-overlay-primary uk-position-bottom");
    			add_location(div0, file, 58, 6, 1434);
    			attr_dev(a, "href", /*linkImage*/ ctx[3]);
    			attr_dev(a, "class", "svelte-1sqhcuw");
    			add_location(a, file, 56, 4, 1334);
    			attr_dev(header, "class", "image uk-inline svelte-1sqhcuw");
    			attr_dev(header, "uk-lightbox", "transition: fade");
    			add_location(header, file, 55, 2, 1266);
    			add_location(div1, file, 65, 6, 1595);
    			add_location(hr0, file, 66, 6, 1629);
    			add_location(div2, file, 67, 6, 1642);
    			add_location(hr1, file, 68, 6, 1678);
    			add_location(div3, file, 69, 6, 1691);
    			add_location(hr2, file, 70, 6, 1725);
    			add_location(div4, file, 71, 6, 1738);
    			attr_dev(div5, "class", "details svelte-1sqhcuw");
    			add_location(div5, file, 64, 4, 1567);
    			add_location(div6, file, 63, 2, 1557);
    			attr_dev(div7, "class", "container svelte-1sqhcuw");
    			add_location(div7, file, 54, 0, 1240);
    		},
    ...
    let albums = [
      {
        ...
        title: 'Ten',
        imgUrl:
          'https://downloads-pearljam-com.s3.amazonaws.com/img/album-art/0223194507ten.jpg',
      },
      {
        artist: 'Pearl Jam',
        title: 'Vs.',
        imgUrl:
          'https://downloads-pearljam-com.s3.amazonaws.com/img/album-art/0223194511vs.jpg',
      },
      {
        artist: 'Pearl Jam',
        title: 'Vitalogy',
        imgUrl:
          'https://downloads-pearljam-com.s3.amazonaws.com/img/album-art/146705358615f16cbe6ba7824e978e71a2d1e3b01c.jpg',
      },
      {
        artist: 'Pearl Jam',
        title: 'No Code',
        imgUrl:
          'https://downloads-pearljam-com.s3.amazonaws.com/img/album-art/1467053858f38820e819828757920ff62553d3f272.jpg',
      },
      {
        artist: 'Pearl Jam',
        title: 'Yield',
        imgUrl:
          'https://downloads-pearljam-com.s3.amazonaws.com/img/album-art/146705364672eb2779614ddaeff42cfbf870747be3.jpg',
      },
      {
        artist: 'Pearl Jam',
        title: 'Binaural',
        imgUrl:
          'https://downloads-pearljam-com.s3.amazonaws.com/img/album-art/14670534484ae466277d40a33c794818dd9309a82f.jpg',
      },
      {
        artist: 'Pearl Jam',
        title: 'Riot Act',
        imgUrl:
          'https://downloads-pearljam-com.s3.amazonaws.com/img/album-art/14670535015bc0a66f237554c64a615c4a02705466.jpg',
      },
      {
        artist: 'Pearl Jam',
        title: 'Pearl Jam',
        imgUrl:
          'https://downloads-pearljam-com.s3.amazonaws.com/img/album-art/146705338292a9031c4ea0f53a9f775f9bd6c6958c.jpg',
      },
      {
        artist: 'Pearl Jam',
        title: 'Backspacer',
        imgUrl:
          'https://downloads-pearljam-com.s3.amazonaws.com/img/album-art/14670537393d01135e7ca3c717e8fe2e5c3c123fbe.jpg',
      },
      {
        artist: 'Pearl Jam',
        title: 'Lightning Bolt',
        imgUrl:
          'https://downloads-pearljam-com.s3.amazonaws.com/img/album-art/1463090805020c40c2530cde7fe2b6e223731e7c10.jpg',
      },
      {
        artist: 'Pearl Jam',
        title: 'Gigaton',
        imgUrl:
          'https://downloads-pearljam-com.s3.amazonaws.com/img/album-art/1585260994e9baa31707c983c41eb47753c14e4029.jpg',
      },
    ];
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$2, 224, 4, 5562);
    			attr_dev(section, "class", "svelte-19edh80");
    			add_location(section, file$2, 223, 2, 5539);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 201, 4, 4902);
    			attr_dev(section0, "class", "svelte-19edh80");
    			add_location(section0, file$2, 170, 2, 4017);
    			attr_dev(section1, "class", "svelte-19edh80");
    			add_location(section1, file$2, 209, 2, 5104);
    		},
    		m: function mount(target, anchor, remount) {
    ...
    // (172:4) {#if previousPage != '' || nextPage != ''}
    function create_if_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(172:4) {#if previousPage != '' || nextPage != ''}",
    		ctx
    	});
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 180, 8, 4354);
    		},
    		m: function mount(target, anchor, remount) {
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 173, 8, 4163);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, button, anchor);
    			if (remount) dispose();
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "uk-button uk-button-default uk-margin-right");
    			add_location(button, file$2, 194, 8, 4734);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, button, anchor);
    			if (remount) dispose();
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "uk-button uk-button-default uk-margin-right");
    			button.disabled = true;
    			add_location(button, file$2, 187, 8, 4551);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, button, anchor);
    			if (remount) dispose();
    ...
    // (211:4) {#each characters as character}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(211:4) {#each characters as character}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "svelte-19edh80");
    			add_location(section, file$2, 282, 2, 7374);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    ...
    function create_fragment$2(ctx) {
    	...
    	let current;
    	let dispose;
    	const if_block_creators = [create_if_block_1, create_if_block_5];
    	const if_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			span0 = element("span");
    			span0.textContent = "Character Name:";
    			t9 = space();
    			input0 = element("input");
    			t10 = space();
    			span1 = element("span");
    			span1.textContent = "Character Status:";
    			t12 = space();
    			input1 = element("input");
    			t13 = space();
    			span2 = element("span");
    			span2.textContent = "Character Species:";
    			t15 = space();
    			input2 = element("input");
    			t16 = space();
    			span3 = element("span");
    			span3.textContent = "Character Gender:";
    			t18 = space();
    			...
    			add_location(input0, file$2, 242, 6, 6159);
    			attr_dev(span1, "for", "characterStatus");
    			attr_dev(span1, "class", "svelte-19edh80");
    			add_location(span1, file$2, 247, 6, 6301);
    			...
    			add_location(input1, file$2, 248, 6, 6360);
    			attr_dev(span2, "for", "characterSpecies");
    			attr_dev(span2, "class", "svelte-19edh80");
    			add_location(span2, file$2, 253, 6, 6509);
