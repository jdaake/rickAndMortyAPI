    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 61, 6, 1491);
    			attr_dev(i, "class", i_class_value = "" + (null_to_empty(/*statusClass*/ ctx[6]) + " svelte-3iy5fs"));
    			add_location(i, file, 64, 10, 1614);
    			attr_dev(h3, "class", "svelte-3iy5fs");
    			add_location(h3, file, 63, 8, 1599);
    			attr_dev(div0, "class", "uk-overlay uk-overlay-primary uk-position-bottom svelte-3iy5fs");
    			add_location(div0, file, 62, 6, 1528);
    			attr_dev(a, "href", /*image*/ ctx[2]);
    			attr_dev(a, "class", "svelte-3iy5fs");
    			add_location(a, file, 60, 4, 1468);
    			attr_dev(header, "class", "image uk-inline svelte-3iy5fs");
    			attr_dev(header, "uk-lightbox", "transition: fade");
    			add_location(header, file, 59, 2, 1400);
    			add_location(div1, file, 72, 6, 1745);
    			add_location(hr0, file, 73, 6, 1779);
    			add_location(div2, file, 74, 6, 1792);
    			add_location(hr1, file, 75, 6, 1828);
    			add_location(div3, file, 76, 6, 1841);
    			add_location(hr2, file, 77, 6, 1875);
    			add_location(div4, file, 78, 6, 1888);
    			attr_dev(div5, "class", "details svelte-3iy5fs");
    			add_location(div5, file, 71, 4, 1717);
    			add_location(div6, file, 70, 2, 1707);
    			attr_dev(div7, "class", "container svelte-3iy5fs");
    			attr_dev(div7, "uk-parallax", "opacity: 0,1; y: 400,0; viewport: 0.35;");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$4, 57, 4, 1123);
    			attr_dev(h2, "class", "uk-modal-title");
    			add_location(h2, file$4, 63, 6, 1274);
    			attr_dev(div0, "class", "uk-modal-header");
    			add_location(div0, file$4, 62, 4, 1238);
    			input0.autofocus = /*autofocus*/ ctx[0];
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "name", "characterName");
    			attr_dev(input0, "class", "svelte-1mtx9px");
    			add_location(input0, file$4, 70, 8, 1473);
    			attr_dev(label0, "for", "characterName");
    			attr_dev(label0, "class", "svelte-1mtx9px");
    			add_location(label0, file$4, 68, 6, 1423);
    			attr_dev(input1, "uk-tooltip", "Dead, alive, or unknown");
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "name", "characterStatus");
    			attr_dev(input1, "class", "svelte-1mtx9px");
    			add_location(input1, file$4, 78, 8, 1670);
    			attr_dev(label1, "for", "characterStatus");
    			attr_dev(label1, "class", "svelte-1mtx9px");
    			add_location(label1, file$4, 76, 6, 1616);
    			attr_dev(input2, "uk-tooltip", "Human, humanoid, robot, unknown, etc.");
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "name", "characterSpecies");
    			attr_dev(input2, "class", "svelte-1mtx9px");
    			add_location(input2, file$4, 86, 8, 1898);
    			attr_dev(label2, "for", "characterSpecies");
    			attr_dev(label2, "class", "svelte-1mtx9px");
    			add_location(label2, file$4, 84, 6, 1842);
    			attr_dev(input3, "uk-tooltip", "Male or Female");
    			attr_dev(input3, "type", "text");
    			attr_dev(input3, "name", "characterGender");
    			attr_dev(input3, "class", "svelte-1mtx9px");
    			add_location(input3, file$4, 94, 8, 2140);
    			attr_dev(label3, "for", "characterGender");
    			attr_dev(label3, "class", "svelte-1mtx9px");
    			add_location(label3, file$4, 92, 6, 2086);
    			attr_dev(div1, "class", "uk-modal-body");
    			add_location(div1, file$4, 67, 4, 1389);
    			attr_dev(button1, "class", "uk-button uk-button-default uk-modal-close");
    			attr_dev(button1, "type", "button");
    			add_location(button1, file$4, 102, 6, 2362);
    			attr_dev(button2, "class", "uk-button uk-button-default uk-modal-close");
    			attr_dev(button2, "type", "button");
    			add_location(button2, file$4, 108, 6, 2519);
    			attr_dev(div2, "class", "uk-modal-footer uk-text-right");
    			add_location(div2, file$4, 101, 4, 2312);
    			attr_dev(div3, "class", "uk-modal-dialog");
    			add_location(div3, file$4, 56, 2, 1089);
    			attr_dev(div4, "id", "search-modal");
    			attr_dev(div4, "uk-modal", "");
    			add_location(div4, file$4, 55, 0, 1054);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
